...
BEGIN
    ...
    ADD WhatsAppStatus INT NOT NULL DEFAULT 0,  -- 0=PENDING, 1=PROCESSING, 2=SENT, 3=FAILED
...
BEGIN
    ALTER TABLE Clinic_PatientsAppointments
    ADD ScheduleWhatsAppStatus INT NOT NULL DEFAULT 0,  -- 0=PENDING, 1=PROCESSING, 2=SENT, 3=FAILED
